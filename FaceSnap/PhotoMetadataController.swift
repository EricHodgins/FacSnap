...
class PhotoMetadataController: UITableViewController {
    ...
    lazy var tagsTextField: UITextField = {
        ...
        textField.placeholder = "summer, vaction"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case (1, 0):
            ...
            NSLayoutConstraint.activate([
                ...
                activityIndicator.leftAnchor.constraint(equalTo: cell.contentView.leftAnchor, constant: 20),
        ...
        case (2, 0):
            ...
            NSLayoutConstraint.activate([
                ...
                tagsTextField.rightAnchor.constraint(equalTo: cell.rightAnchor, constant: 16.0),
...
extension PhotoMetadataController {
    func tagsFromTextField() -> [String] {
        ...
        return lowercaseTags.map { $0.trimmingCharacters(in: NSCharacterSet.whitespaces) }
    }
}
